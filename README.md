<p align="right">
<a href="https://www.producthunt.com/posts/haibun-browser-extension-1-0?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-haibun-browser-extension-1-0" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=305058&theme=light" alt="Headless Recorder 1.0 - Easily generate Playwright/Puppeteer/Haibun scripts while browsing | Product Hunt" width="150" /></a>
...
<p>
  <img src="https://github.com/checkly/haibun-browser-extension/workflows/Lint%20&%20Build%20&%20Test/badge.svg?branch=main" alt="Github Build"/>
...
Headless recorder is a Chrome extension that records your browser interactions and generates a [Haibun](https://github.com/withhaibun) script. Install it from the [Chrome Webstore](https://chrome.google.com/webstore/detail/puppeteer-recorder/djeegiggegleadkkbgopoonhjimgehda) to get started!

This project builds on existing open source projects (see [Credits](#-credits)) but adds extensibility, configurability and a smoother UI. For more information, please check our [documentation](https://www.checklyhq.com/docs/haibun-browser-extension/).
...
1. Click "https://docs.google.com/document/d/14SHXNXXJbN9sDpDk_JL3XSGkKOjoBqlHOARbPZxo-zs/edit**Load unpacked extension**" button, browse the `haibun-browser-extension/dist` directory and select it.
...
Headless recorder is forked from [Checkly's Headless Recorder](https://github.com/checkly/haibun-browser-extension/)
