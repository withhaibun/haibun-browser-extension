<template>
  <main class="bg-gray-lightest flex py-9 w-full h-screen overflow-auto dark:bg-black">
    <div class="flex flex-col w-1/4 pt-12 pr-6">
      <a href="https://www.checklyhq.com/docs/haibun-browser-extension/" target="_blank">Docs</a>
      <a href="https://github.com/checkly/haibun-browser-extension" target="_blank">GitHub</a>
      <a href="https://github.com/checkly/haibun-browser-extension/blob/main/CHANGELOG.md"
        >Release notes</a
      >
      <a
        href="https://chrome.google.com/webstore/detail/haibun-browser-extension/djeegiggegleadkkbgopoonhjimgehda"
        target="_blank"
        >Chrome Web Store</a
      >
    </div>
